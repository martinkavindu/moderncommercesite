    ...
    <section className='cart-wrapper home-wrapper-2 py-2'>
        <div className='container-xxl'>
            <div className='row'>
                ...
                <h4 className='cart-col-3'> Total</h4>
                    </div>
...
<div className='75'>
    <h5 className='title'>Generic Portable Blender</h5>
    <p className='color'>Brand: Generic</p>
    <p className='size'>In stock</p>
</div>
              </div>
